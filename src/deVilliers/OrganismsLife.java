...
public class OrganismsLife
{
    ...
    public OrganismsLife(String sFileName, Integer lbl)
    {
        readCSV rcsv = new readCSV();
        food = rcsv.readfile("TrainingSet.csv");
        creature = new OrganismA(lbl, food.get(0));
    ...
    public OrganismsLife(input initial, Integer lbl, Integer N)
    {
    ...
    public OrganismsLife(input initial, Integer lbl, Integer N, Double[] beta)
    {
    ...
    public void popT()
    {
        for (int i = 0; i <= creature.getBeta().length - 1; i++)
        {
